...
export const ThreadsIcon = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
export const GlobeIcon = ({ className, ...rest }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M5.746 98.304H199.48v8.618H5.746zM104.941 62.111c-48.644 0-84.94-10.704-87.199-11.388l2.494-8.253c.816.247 82.657 24.336 164.38-.004l2.452 8.26c-28.663 8.54-57.047 11.385-82.127 11.385zM20.416 160.572l-2.459-8.26c84.271-25.081 165.898-1.027 169.333 0l-2.494 8.256c-.82-.25-82.654-24.328-164.38.004z"
        style={{
          fill: "currentColor",
        }}
      />
      <path
        d="M69.399 196.168C26.933 96.747 63.584 8.604 63.959 7.727l7.927 3.378c-.365.845-35.534 85.756 5.44 181.677l-7.927 3.386zM135.168 196.168l-7.927-3.382c40.971-95.92 5.801-180.832 5.436-181.677l7.927-3.378c.369.873 37.023 89.016-5.436 188.437zM98.306 5.744h8.614v197.302h-8.614z"
        style={{
          fill: "currentColor",
        }}
      />
